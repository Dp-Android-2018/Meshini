...
public class SpinnerAdapter extends ArrayAdapter<CountryCityPojo> {

    public SpinnerAdapter(Context context, List<CountryCityPojo> countryCityPojos){
    ...
    private View initView(int position, View convertView, ViewGroup parent) {
        ...
        CountryCityPojo currentItem = getItem(position);
