...
public class SharedPrefrence {
    ...
    public SharedPrefrence(Context context) {
        ...
        prefs = context.getSharedPreferences(ConstantsFile.SharedPref.SHARED_PREF_NAME, context.MODE_PRIVATE);
        editor = context.getSharedPreferences(ConstantsFile.SharedPref.SHARED_PREF_NAME, context.MODE_PRIVATE).edit();
    }
